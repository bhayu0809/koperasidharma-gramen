	...
	<tbody>
		...
		<tr id='row-<?php echo $num_row?>'>
			...
			<td class='actions' >
				...
				?>
						<a style="font-size:10px !important" href="<?php echo $action_url; ?>"  class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
				...
				?>
				<?php if(!$unset_read){?>
					<a style="font-size:10px !important" href="<?php echo $row->read_url?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
				...
				<?php if(!$unset_edit){?>
					<a style="font-size:10px !important" href="<?php echo $row->edit_url?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
				...
				<?php if(!$unset_delete){?>
					<a style="font-size:10px !important" onclick = "javascript: return delete_row('<?php echo $row->delete_url?>', '<?php echo $num_row?>')"
