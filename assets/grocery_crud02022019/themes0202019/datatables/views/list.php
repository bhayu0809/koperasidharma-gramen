<table cellpadding="0" style="font-size:11px;"cellspacing="0" border="0" class="display groceryCrudTable" id="<?php echo uniqid(); ?>">
	<thead>
		<tr>
	...
	<tbody>
		...
		<tr id='row-<?php echo $num_row?>'>
			...
			<?php }?>
			<?php if(!$unset_delete || !$unset_edit || !$unset_read || !empty($actions)){?>
			<td class='actions' style="margin-left:0">
				<?php
				...
				?>
						<a href="<?php echo $action_url; ?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
							<span style="font-size:11px;text-align:left" class="ui-button-icon-primary ui-icon <?php echo $action->css_class; ?> <?php echo $action_unique_id;?>"></span><span class="ui-button-text">&nbsp;<?php echo $action->label?></span>
						</a><br/>
				<?php }
				}
				?>
				<?php if(!$unset_read){?>
					<a  href="<?php echo $row->read_url?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
						...
						<span style="font-size:11px;text-align:left" class="ui-button-text">&nbsp;<?php echo $this->l('list_view'); ?></span>
					</a><br/><br/>
				<?php }?>

				<?php if(!$unset_edit){?>
					<a style="font-size:11px;text-align:left"  href="<?php echo $row->edit_url?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
						<span class="ui-button-icon-primary ui-icon ui-icon-pencil"></span>
						<span style="font-size:11px;text-align:left" class="ui-button-text">&nbsp;<?php echo $this->l('list_edit'); ?></span>
					</a><br/><br/>
				<?php }?>
				<?php if(!$unset_delete){?>
					<a style="font-size:11px;text-align:left"  onclick = "javascript: return delete_row('<?php echo $row->delete_url?>', '<?php echo $num_row?>')"
						...
						<span style="font-size:11px;text-align:left" class="ui-button-text">&nbsp;<?php echo $this->l('list_delete'); ?></span>
					</a><br/><br/>
				<?php }?>
			</td>
			<?php }?>
