...
<?php }?>
<?php if(!$unset_export){?>
<div class="datatables-export-button">
<a role="button" class="add_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" href="<?php echo $export_url?>">
	<span class="ui-button-icon-primary ui-icon ui-icon-circle-plus"></span>
	<span class="ui-button-text"><?php echo $this->l('list_export'); ?> <?php echo $subject?></span>
</a>
</div>
<?php }?>
