...
class Bayar extends OperatorController {
	...
	public function index() {
		...
		$this->data['judul_sub'] = 'Pembayaran Angsuran '.$this->data['anggota']->nama;;
	...
	function ajax_list($id = null) {
		...
		$data   = $this->bayar_m->get_data_transaksi_ajax($offset,$limit,$search,$sort,$order,$id);
		$i	= 0;
		$rows   = array(); 
		...
		foreach ($data['data'] as $r) {
			...
			$rows[$i]['lama_angsuran_txt'] = $r->lama_angsuran.' Minggu';
