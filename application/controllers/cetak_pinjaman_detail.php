	...
	function cetak($id) {
		...
		<table width="100%" cellspacing="0" cellpadding="3" border="1" border-collapse= "collapse">';
			...
			<tr>
				...
				<td> : Rp. </td>
				<td class="h_kanan"> '.number_format(nsi_round($row->pokok_angsuran +  $row->bunga_pinjaman + $row->biaya_adm)).'</td>
			</tr>
			<tr>
				<td > Nomor Pinjam </td>
				<td > :  </td>
			...
			<tr>
				<td> Lama Pinjam </td>
				<td> : </td>
				<td> '.$row->lama_angsuran.' Minggu</td>
			</tr>';
			$html .= '</table>';

			$tagihan = ($row->pokok_angsuran +  $row->bunga_pinjaman + $row->biaya_adm) * $row->lama_angsuran;
			...
			<tr>
				<td> Sisa Pokok </td>
				<td class="h_kanan"> '.number_format(nsi_round($sisa_pokok )).'</td>
			</tr>
			<tr>
				<td> Sisa Jasa </td>
				<td class="h_kanan"> '.number_format(nsi_round($sisa_jasa )).'</td>
			</tr>
			<tr>
				<td> Sisa Tagihan </td>
