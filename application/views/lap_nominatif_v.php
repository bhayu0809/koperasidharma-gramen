...
<div class="box box-solid box-primary">
	<div class="box-header">
		<h3 class="box-title">Laporan Nominatif</h3>
		<div class="box-tools pull-right">
			<button class="btn btn-primary btn-sm" data-widget="collapse">
				<i class="fa fa-minus"></i>
			</button>
...
<div class="box-body">
<p></p>
<p style="text-align:center; font-size: 15pt; font-weight: bold;"> Laporan Nominatif Simpanan dan Pinjaman Anggota</p><p style="text-align:center;font-weight:bold"> Per Tanggal. <?php echo $tgl_periode_txt; ?> </p>
	...
	foreach($data_hasil AS $k=>$v){
		...
		foreach($v AS $k2=>$v2){
			...
			echo '<tr>
				...
				<td>'.number_format($v2['jumlah_simpanan']).'</td>
