...
url="<?php echo site_url('penarikan/ajax_list/'.$aid); ?>" 
...
<thead>
	<tr>
		...
		<th data-options="field:'departement', width:'15',halign:'center', align:'left'">Area</th>
						...
						<tr style="height:35px">
							...
							<td>
								<!--<div class="input-group date dtpicker col-md-5" style="z-index: 9999 !important;">-->
									...
									<input type="text" name="tgl_transaksi" class="dtpicker" id="tgl_transaksi" required="true" />
