...
<li  class="treeview <?php 
	...
	<?php if($level != 'pinjaman') { ?>
		...
		<li class="<?php if ($this->uri->segment(1) == 'lap_pemasukan_harian') { echo 'active'; } ?>"> <a href="<?php echo base_url(); ?>lap_pemasukan_harian"><i class="fa fa-folder-open-o"></i> Laporan transaksi harian(Pemasukan)</a></li>
		
		<li class="<?php if ($this->uri->segment(1) == 'lap_pengeluaran_harian') { echo 'active'; } ?>"> <a href="<?php echo base_url(); ?>lap_pengeluaran_harian"><i class="fa fa-folder-open-o"></i> Laporan transaksi harian(Pengeluaran)</a></li>
	
		<li class="<?php if ($this->uri->segment(1) == 'lap_nominatif') { echo 'active'; } ?>"> <a href="<?php echo base_url(); ?>lap_nominatif"><i class="fa fa-folder-open-o"></i> Laporan Nominatif</a></li>
		<li class="<?php if ($this->uri->segment(1) == 'lap_sisajasa') { echo 'active'; } ?>"> <a href="<?php echo base_url(); ?>lap_sisajasa"><i class="fa fa-folder-open-o"></i> Laporan Sisa Jasa</a></li>

		<li class="<?php if ($this->uri->segment(1) == 'lap_bulanan') { echo 'active'; } ?>"> <a href="<?php echo base_url(); ?>lap_bulanan"><i class="fa fa-folder-open-o"></i> Laporan Bulanan (Pemasukan)</a></li>
		<li class="<?php if ($this->uri->segment(1) == 'lap_bulanan_pengeluaran') { echo 'active'; } ?>"> <a href="<?php echo base_url(); ?>lap_bulanan_pengeluaran"><i class="fa fa-folder-open-o"></i> Laporan Bulanan (Pengeluaran)</a></li>
		...
		<li class="<?php if ($this->uri->segment(1) == 'perhitungan_shu') { echo 'active'; } ?>"> <a href="<?php echo base_url(); ?>perhitungan_shu"><i class="fa fa-folder-open-o"></i> Perhitungan SHU </a></li>
		<?php } ?>
	</ul>
</li>
...
<ul class="treeview-menu">
	...
	<li class="<?php if ($this->uri->segment(1) == 'pekerjaan') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>pekerjaan"> <i class="fa fa-folder-open-o"></i> Master Pekerjaan</a></li>
	<li class="<?php if ($this->uri->segment(1) == 'area') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>area"> <i class="fa fa-folder-open-o"></i> Master Area</a></li>
	<li class="<?php if ($this->uri->segment(1) == 'area') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>pendidikan"> <i class="fa fa-folder-open-o"></i> Master Pendidikan</a></li>
	<li class="<?php if ($this->uri->segment(1) == 'area') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>hubungan"> <i class="fa fa-folder-open-o"></i> Master Hubungan</a></li>
...
<ul class="treeview-menu">          
	...
	<li class="<?php if ($this->uri->segment(1) == 'kunci') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>kunci"> <i class="fa fa-key"></i> Kunci </a></li>
</ul>
</li>
<?php } ?>
