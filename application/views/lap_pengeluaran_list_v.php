...
<div class="box box-solid box-primary">
	<div class="box-header">
		<h3 class="box-title">Laporan Pengeluaran Harian</h3>
...
<div class="box-body">
<p></p>
<p style="text-align:center; font-size: 15pt; font-weight: bold;"> Laporan Transaksi Harian (Pengeluaran)</p><p style="text-align:center;font-weight:bold"> Per Tanggal. <?php echo $tgl_periode_txt; ?> </p>
	...
	foreach($data_hasil AS $k=>$v){
		echo '<tr>
			...
			<tr class="header_kolom">
				...
				<th style="width:20%; vertical-align: middle; text-align:center" rowspan="2"> Pinjaman  </th>
			</tr>
			<tr class="header_kolom">
...
function clearSearch(){
	window.location.href = '<?php echo site_url("lap_pengeluaran_harian"); ?>';
}
...
function doSearch() {
	...
	$('#fmCari').attr('action', '<?php echo site_url('lap_pengeluaran_harian'); ?>');
	$('#fmCari').submit();	
}
...
function cetak () {
	...
	var win = window.open('<?php echo site_url("lap_pengeluaran_harian/cetak/?tgl_dari=' + tgl_dari + '&tgl_samp=' + tgl_samp + '"); ?>');
	if (win) {
		win.focus();
	} else {
