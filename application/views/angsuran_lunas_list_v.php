			...
			<tr>
				...
				<td>
					...
					<tr>
						<td> Lama Pinjaman</td> 
						<td> : </td>
						<td> <?php echo $row_pinjam->lama_angsuran; ?> Minggu</span></td>
					</tr>
					</table>
				</td>
				<td>
...
<div id="dialog-form" class="easyui-dialog" show= "blind" hide= "blind" modal="true" resizable="false" style="width:400px; height:340px; padding: 20px 25px" closed="true" buttons="#dialog-buttons" style="display: none;">
	<form id="form" method="post" novalidate>
		...
		<tr style="height:30px">
			<td> Jumlah Pokok Angsuran</td>
			<td> :</td>
			<td> <input type="text" class="easyui-numberbox" id="jml_pokok_angsuran" name="jml_pokok_angsuran" data-options="precision:0,groupSeparator:',',decimalSeparator:','," class="easyui-validatebox" required="true" style="width:201px; height:23px"/>
				</td>
		</tr>	
		<tr style="height:30px">
			<td> Jumlah Jasa Angsuran</td>
			<td> :</td>
			<td> <input type="text" class="easyui-numberbox" id="jml_jasa_angsuran" name="jml_jasa_angsuran" data-options="precision:0,groupSeparator:',',decimalSeparator:','," class="easyui-validatebox" required="true" style="width:201px; height:23px"/>
				</td>
		</tr>	
		<tr>
			<td> Simpan Ke Kas</td>
