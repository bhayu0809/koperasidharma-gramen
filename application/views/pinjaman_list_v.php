...
url="<?php echo site_url('pinjaman/ajax_list/'.$aid); ?>" 
...
striped="true">
<thead>
	<tr data-options="field:'color_late'">
...
<div id="tb" style="height: 35px;">
	...
	<div class="pull-right" style="vertical-align: middle;">
		...
		<span>Cari :</span>
		<!--<input name="kode_transaksi" id="kode_transaksi" onChange="doSearch()" size="23" placeholder="Kode Transaksi" style="line-height:22px;border:1px solid #ccc">
		<input name="cari_nama" id="cari_nama" onChange="doSearch()" size="23" placeholder="Nama Anggota" style="line-height:22px;border:1px solid #ccc">
				...
				<td>
					<table>
						<tr style="height:35px">
							...
							<td>
								<!--<div class="input-group date dtpicker col-md-5" style="z-index: 9999 !important;">-->
									<input type="text" name="tgl_pinjam" class="dtpicker" id="tgl_pinjam_txt"  required="true"  />
								<!--</div>-->
							</td>	
						</tr>
							<tr style="height:35px">
							...
							<td>:</td>
							<td>
								<input id="anggota_nama" name="anggota_nama" readonly="true" style="width:195px; height:25px;background:#eee;" class="easyui-validatebox" >
						...
						<tr style="height:35px">
							...
							<td>:</td>
							<td>
								<input class="" id="jasa" name="jasa" style="width:195px; height:25px;"  />
							</td>	
						</tr>
						<tr style="height:35px">
							<td>Pokok</td>
							<td>:</td>
							<td>
								<input class="" id="pokok" name="pokok" style="width:195px; height:25px;"  />
							</td>	
						</tr>
						<tr style="height:35px">
							<td>Lama Angsuran</td>
							...
							<td>
								<select id="lama_angsuran" name="lama_angsuran" style="width:200px; height:23px" class="easyui-validatebox" required="true">
									...
									foreach ($jenis_ags as $row) {
										echo '<option value="'.$row->ket.'">'.$row->ket.' '.$row->satuan.'</option>';
									}
									?>
								</select>
							</td>	
						...
						<tr style="height:35px">
							...
							<td>:</td>
							<td>
								<input type="text" name="bunga" id="bunga" /><!--readonly="readonly" />-->
...
function create(){
	...
	$('#anggota_nama').css('background-color', '#eee');

	jQuery('#barang_id option[value="0"]').prop('selected', true);
	jQuery('#anggota_nama').val("<?php echo $anggota->nama;?>");
	jQuery("input[name=anggota_id]").val('<?php echo $anggota->id;?>');
	...
	// $('#jasa').keyup(function(){
		// var val_jumlah = $(this).val();
		// //$('#jumlah').numberbox('setValue', number_format(val_jumlah));
		// $('#jasa').val(number_format(val_jumlah));
	// });
	
	// $('#pokok').keyup(function(){
		// var val_jumlah = $(this).val();
		// //$('#jumlah').numberbox('setValue', number_format(val_jumlah));
		// $('#pokok').val(number_format(val_jumlah));
	// });
...
function update(){
	...
	function cetak_laporan () {
		...
		var kode_transaksi 	= "<?php echo $anggota->id ?>";
