...
<head>
	<meta charset="UTF-8">
	<title>Login-DWP BINA SEJAHTERA</title>
	...
	<div class="form-box" id="login-box">
		...
		<form action="" method="post">
			<div class="body bg-gray">
				...
				<?php } else { ?>
					<h4><center>Admin Login</h4></center> <!-- - <a href="<?php echo site_url('member'); ?>" class="btn btn-primary">Member</a></h4> -->
				<?php } ?>
			...
			<div class="footer"> 
				<center>&copy; Copyright <?php echo date('Y'); ?> | DWP BINA SEJAHTERA.</center> 
			</div>
		</form>
	</div>
