...
if(in_array($row_pinjam->lama_angsuran,array("20","40"))){
	$satuan = "Minggu";
}else{
	$satuan = "Bulan";
}
				...
				<td>
					<table style="width:100%">
						...
						<tr>
							...
							<td> : </td>
							<td class="h_kanan"> <?php echo number_format(($row_pinjam->biaya_adm) + ($row_pinjam->bunga_pinjaman),2); ?></td>
						</tr>
						<tr>
...
<table  class="table table-bordered">
	<tr class="header_kolom">
		<th style="width:10%; vertical-align: middle"> <?php echo $satuan; ?> ke</th>
...
if(!empty($simulasi_tagihan)) {
	...
	foreach ($simulasi_tagihan as $row) {
		...
		echo '
			<tr bgcolor='.$warna.'>
				...
				<td class="h_kanan">'.number_format($row['bunga_pinjaman'],2).'</td>
	...
	echo '<tr bgcolor="#eee">
				...
				<td class="h_kanan"><strong>'.number_format(nsi_round($jml_ags),2).'</strong></td>
				<td></td>
			</tr>
		</table>';
}
