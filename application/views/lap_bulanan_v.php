...
<div class="box-body">
<p></p>
<p style="text-align:center; font-size: 15pt; font-weight: bold;"> Laporan Ringkas Bulan</p><p style="text-align:center;font-weight:bold"> Per Bulan. <?php echo $tgl_periode_txt; ?> </p>
	...
	<table  class="table table-bordered body-table">
		...
		<?php 
			...
			foreach($hasil AS $k=>$v){
				...
				echo "<td>".number_format($v['cicilan'])."</td>";
				echo "<td>".number_format($v['pinjaman_sisa_pokok'])."</td>";
				echo "<td>".number_format($v['jasa_dibayar'])."</td>";
				echo "</tr>";
		...
		<tfoot >
			<tr class="tfoot">
				...
				<th><?php echo number_format($total_cicilan); ?></th>
				<th><?php echo number_format($total_sisa_pokok); ?></th>
				<th><?php echo number_format($total_jasa_dibayar); ?></th>
			</tr>
		</tfoot>
	</table>
</div>
