...
url="<?php echo site_url('simpanan/ajax_list/'.$aid); ?>" 
						...
						<tr style="height:35px">
							...
							<td>
								<!--<div class="input-group date dtpicker col-md-5" style="z-index: 9999 !important;">-->
									...
									<input type="text" name="tgl_transaksi" class="dtpicker"  required="true"id="tgl_transaksi" />
...
function create(){
	...
	$('#anggota_nama').val("<?php echo $anggota->nama;?>");
	$("input[name=anggota_id]").val('<?php echo $anggota->id;?>');
