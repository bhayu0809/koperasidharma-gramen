...
class Angsuran_lunas_m extends CI_Model {
	...
	public function create() {
		...
		$jumlah_bayar = (str_replace(',', '', $this->input->post('jml_pokok_angsuran')) + str_replace(',', '', $this->input->post('jml_jasa_angsuran'))) * 1;
		...
		$data = array(			
						...
						'angsuran_ke'	=>	$ags_ke,
						'jumlah_bayar'	=>	str_replace(',', '', $this->input->post('jml_pokok_angsuran')) + str_replace(',', '', $this->input->post('jml_jasa_angsuran')),
						'jml_pokok_angsuran'	=>	str_replace(',', '', $this->input->post('jml_pokok_angsuran')),
						'jml_jasa_angsuran'	=>	str_replace(',', '', $this->input->post('jml_jasa_angsuran')),
						'ket_bayar'		=>	'Pelunasan',
